...
func SetTitle()
    if &filetype == 'sh'
        ...
        call append(line(".")+2, "#   E-mail: echo ZDVuY2gzY2tAZGlzcm9vdC5vcmcK | base64 -d")
        ...
        call setline(1, "/**=====================================================================")
        call append(line("."),   " *    Author: D5Nch3ck, (https://github.com/D5Nch3ck)")
        call append(line(".")+1, " *    E-mail: echo ZDVuY2gzY2tAZGlzcm9vdC5vcmcK | base64 -d")
